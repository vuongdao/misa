...
<section class="content">
	<div class="panel"><a href="#" class="large text-blue hover-opacity">< Mua thêm sản phẩm khác</a></div>
	<div class="row section">
		<div class="twothird container">
			<h2 class="medium grey margin-0 padding">Giỏ hàng của bạn</h2>
			<div class="white">
				<div class="row">
				...
				<hr>
				<div class="container white padding-bottom">
					<h4 class="left "><b>Tổng tiền:</b></h4>
					<h4 class="right  text-red"><b>900,000đ</b></h4>
				</div>
			</div>
		</div>
		<div class="third container">
			<h2 class="medium grey margin-0 padding">Thông tin thanh toán</h2>
			<div class="white">
				<div class="container">
					<form action="">
